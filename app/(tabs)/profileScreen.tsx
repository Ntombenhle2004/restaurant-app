...
// //       setProfile({
// //         ...profile,
// //         expiry: `${cleaned.slice(0, 2)}/${cleaned.slice(2, 4)}`,
// //       });
// //     } else {
// //       setProfile({ ...profile, expiry: cleaned });
// //     }
// //   };
...
// //         Platform.OS === "web" ? alert(msg) : Alert.alert("Ambrosia", msg);
// //       }
// //     } catch (error) {
...
// //                 try {
// //                   await signOut(auth);
// //                   // Explicitly replace the current view with the Landing Page
// //                   router.replace("/");
// //                 } catch (error) {
...
//   ActivityIndicator,
//   Platform,
//   ActionSheetIOS, // For professional iOS logout prompt
// } from "react-native";
// import { useEffect, useState } from "react";
// import { auth, db } from "../../services/firebase";
// import { doc, getDoc, updateDoc } from "firebase/firestore";
...
// import { StatusBar } from "expo-status-bar";
// import { useRouter } from "expo-router";
// import Toast from "react-native-root-toast"; // Professional Toast
// import InputField from "../components/InputField";
...
//         setOriginalProfile(profile);
//         setIsEditing(false);
//         showToast("Profile Updated Successfully"); // Fancy feedback
//       }
//     } catch (error) {
...
//           cancelButtonIndex: 0,
//           title: "Sign Out",
//           message: "Are you sure you want to log out of Ambrosia?",
//         },
//         (buttonIndex) => {
...
//       );
//     } else {
//       // For Android/Web, we can use a simpler custom logic or just trigger
//       performLogout();
//     }
//   };
...
// // ... DetailItem and Styles remain same as your code
// function DetailItem({ label, value }: { label: string; value: string }) {
//   return (
//     <View style={styles.infoBox}>
//       <Text style={styles.infoLabel}>{label}</Text>
...
import {
  ...
  ActivityIndicator,
  Platform,
  Modal, // Used for a fancy custom logout confirmation
} from "react-native";
import { useEffect, useState } from "react";
import { auth, db } from "../../services/firebase";
import { doc, getDoc, updateDoc } from "firebase/firestore";
